...
export default function ProformaPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    // Generate random invoice/proforma number like "2022067"
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <h1 style={{ margin: 0, color: 'var(--primary)' }}>Generar Factura Proforma</h1>
      ...
      <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          <div className="glass-panel" style={{ padding: '2rem' }}>
            ...
            <textarea 
              className="input-field" 
              placeholder="Ej: Plazo de entrega: 45 días. Validez de la oferta: 15 días. Condición de pago: CBU Banco Galicia Nº 1234567/8..." 
              rows={6}
          ...
          <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '0.5rem' }}>
              <span style={{ fontSize: '1.2rem', fontWeight: 700, color: 'var(--text-main)' }}>Total Proforma:</span>
        ...
        >
          {isSubmitting ? "Guardando en Firebase..." : "💾 Guardar Factura Proforma y Generar Enlace"}
        </button>
      </form>
    </div>
  );
